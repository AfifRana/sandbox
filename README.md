...
- [ ] ADRs: document Kafka versus RabbitMQ, the transactional outbox, Saga orchestration, flash-sale concurrency/consistency, distributed rate limiting, and OAuth2/OIDC trade-offs after those implementations are complete
