...
| `orders-v0.10.0` | PIT mutation testing for order-service application/domain logic, 100% mutation score, E2E verified |
| `orders-v0.10.1` | PIT follow-up: GetOrderUseCase tests close all mutation gaps, 100% mutation score |
...
- [x] PIT mutation testing: 13 mutations generated, 13 killed, 100% score, no survived or no-coverage mutants in application/domain scope
